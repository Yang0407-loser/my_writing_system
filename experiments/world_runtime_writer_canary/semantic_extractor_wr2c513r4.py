"""WR2-C5.1.3-R4 semantic judgment contract and parser.
...
from experiments.world_runtime_writer_canary.semantic_projector_wr2c513r4 import (
    build_delta,
    project,
)


SEMANTIC_EXTRACTOR_VERSION = "world-runtime-semantic-extractor-wr2c513r4-v1"
MAX_JUDGMENTS = 32
...
def parse_semantic_response(
    *,
    ...
    try:
        ...
        raise ValueError("wr2c513r4_invalid_judgment_response") from exc
    ...
    if delta.output_hash != output_hash:
        raise RuntimeError("wr2c513r4_output_hash_mismatch")
