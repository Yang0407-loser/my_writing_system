"""WR2-C5.1.3-R6 semantic judgment contract and parser.
...
SEMANTIC_EXTRACTOR_VERSION = "world-runtime-semantic-extractor-wr2c513r6-v1"
MAX_JUDGMENTS = 32
    ...
    *,
    ...
    if state is None:
        if state_variant is None:
            raise ValueError("wr2c513r6_state_or_state_variant_required")
...
def parse_semantic_response(
    *,
    ...
    try:
        ...
        raise ValueError("wr2c513r6_invalid_judgment_response") from exc
    ...
    if delta.output_hash != output_hash:
        raise RuntimeError("wr2c513r6_output_hash_mismatch")
