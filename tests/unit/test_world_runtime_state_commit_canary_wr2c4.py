...
from experiments.world_runtime_writer_canary import state_commit_canary_wr2c4 as canary
...
def test_generation_messages_include_state_scene_and_previous_placeholder():
...
def test_fake_run_once_calls_six_times_and_cannot_repeat(tmp_path, monkeypatch):
    ...
    assert report["summary"]["no_commit_no_accepted"] == 3
