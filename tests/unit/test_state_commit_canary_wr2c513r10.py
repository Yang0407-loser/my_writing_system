...
from experiments.world_runtime_writer_canary import state_commit_canary_wr2c513r10 as canary
...
def test_runner_is_bound_to_chained_components():
    assert canary.EXTRACTOR.name == "semantic_extractor_wr2c513r9.py"
