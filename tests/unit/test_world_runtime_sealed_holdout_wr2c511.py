...
from experiments.world_runtime_writer_canary import sealed_holdout_wr2c511 as holdout
...
def _synthetic_holdout(tmp_path):
    ...
    payload = {
        "schema_version": "world-runtime-sealed-holdout-wr2c511-v1",
...
def test_fake_run_once_consumes_all_fails_closed_and_cannot_repeat(tmp_path, monkeypatch):
    ...
    assert evaluation["semantic_recall"] < 0.9
