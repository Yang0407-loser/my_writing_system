...
from experiments.world_runtime_writer_canary import sealed_holdout_wr2c512 as holdout
...
def _synthetic_holdout(tmp_path):
    ...
    payload = {
        "schema_version": "world-runtime-sealed-holdout-wr2c512-v1",
...
def test_seal_rejects_gold_validation_mismatch(tmp_path, monkeypatch):
    ...
    # DEV511-PUBLISH-01 is valid per Validator; mark gold as invalid to force conflict.
